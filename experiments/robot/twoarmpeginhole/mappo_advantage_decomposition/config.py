...
class MAPPOConfig:
    ...
    train_proprio_projector: bool = True          # Train proprio projector (gradient flows through frozen backbone)
    ...
    gamma_prime: float = 0.99                         # Microstep discount factor for ACPO
    gae_lambda: float = 0.95                          # GAE lambda for advantage estimation
    lambda_prime: float = 0.95                        # Microstep GAE lambda for ACPO
